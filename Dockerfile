...
# Get source
RUN svn checkout http://v8.googlecode.com/svn/trunk/ /tmp/v8
RUN svn checkout http://pyv8.googlecode.com/svn/trunk/ /tmp/pyv8
...
# Build v8
RUN cd /tmp/v8 && PATH=/tmp/depot_tools:"$PATH" make dependencies
...
RUN mv /tmp/pyv8/build/lib.linux-x86_64-3.5 /tmp/pyv8/build/pyv8
RUN mv /tmp/pyv8/build/pyv8/_PyV8.cpython-35m-x86_64-linux-gnu.so /tmp/pyv8/build/pyv8/_PyV8.so
